...
class TelegramInternetControl(hass.Hass):
    ...
    def initialize(self):
        ...
        # Цель (friendly name из globals.TELEGRAM_TARGETS) для отправки ответов в Telegram
        self.notify_target = self.args.get("notify_target", "telegram")
    ...
    def send_telegram_message(self, message):
        ...
        """
        try:
            globals.send_telegram(self, message, target = self.notify_target)
